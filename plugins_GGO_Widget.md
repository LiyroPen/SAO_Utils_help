# 插件-GGO桌面挂件 {#suh_5-2}
![](https://github.com/LiyroPen/SAO_Utils_help/tree/master/Images/5-2-1.jpg)<br>
左键可以拖动GGO桌面挂件（以下将简称为GGO挂件）的位置，右键或长按其中一个项目（即那个方块）可以使用此项目的菜单<br>
![](https://github.com/LiyroPen/SAO_Utils_help/tree/master/Images/5-2-2.jpg)<br>
排序：可以移动此项目或项目所在行<br>
...
置顶挂件：置顶显示这个GGO挂件<br>
锁定所有挂件：锁定所有GGO挂件，无法移动和使用GGO挂件菜单，如需解锁请点击![](https://github.com/LiyroPen/SAO_Utils_help/tree/master/Images/5-2-3.jpg)解锁<br>
对齐到：移动此GGO挂件到适当位置
...
# 编辑项目 {#suh_5-2-1}
打开GGO挂件项目编辑界面
![](https://github.com/LiyroPen/SAO_Utils_help/tree/master/Images/5-2-1-1.jpg)<br>
...
# 数字或文本 {#suh_5-2-2}
![](https://github.com/LiyroPen/SAO_Utils_help/tree/master/Images/5-2-2-1.jpg)<br>
1：此处选择要显示的数字或文本<br>
注意：![](https://github.com/LiyroPen/SAO_Utils_help/tree/master/Images/5-2-2-2.jpg)![](https://github.com/LiyroPen/SAO_Utils_help/tree/master/Images/5-2-2-3.jpg)![](https://github.com/LiyroPen/SAO_Utils_help/tree/master/Images/5-2-2-4.jpg)都需要相应软件的支持<br>
...
# 上传\下载速度监控 {#suh_5-2-3}
![](https://github.com/LiyroPen/SAO_Utils_help/tree/master/Images/5-2-3-1.jpg)
